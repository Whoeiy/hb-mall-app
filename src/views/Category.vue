              ...
              <div class="swiper-wrapper">
                <template v-for="(category, index) in categoryData">
                  <div class="swiper-slide" v-if="currentIndex == category.categoryId" :key="index">
                     <img class="category-main-img" :src="category.categoryIcon" v-if="category.categoryIcon"/>
...
<!--                          <img class="product-img"  :src="category.categoryIcon"  v-if="category.categoryIcon" />-->
                           <img class="product-img"  v-if="product.categoryIcon" :src="$filters.prefix(product.categoryIcon)"/>
...
export default {
 ...
 setup() {
   ...
   const selectProduct = (item) => {
     ...
     router.push({ path: '/product-list', query: { categoryName: item.categoryName } })
   }
   return {
     ...toRefs(state),
     goHome,
